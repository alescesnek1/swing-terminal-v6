...
function renderFleet() {
  ...
  html += '<div class="fleet-auto-trader">'
    ...
    + '<div><span>Decision</span><b>' + _esc(auto.decision === 'NONE' && auto.decisionReason === 'signal' ? 'SHADOW_BUY_SIGNAL' : (auto.decision !== 'NONE' ? auto.decision : auto.decisionReason || '--')) + '</b></div>'
